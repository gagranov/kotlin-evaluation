...
fun main() {
  ...
  document.writeln("Elapsed time " + results.elapsedTime + " ms. Found=" + results.found + " NotFound=" + results.notFound + " success " + (100.0 * results.found / (results.found + results.notFound)) + "%")
}
